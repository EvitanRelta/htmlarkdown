...
/**
 * The string that's added to the start and end of an ordered-list's markdown.
 *
 ...
 */
export const ORDERED_LIST_BOUNDARY =
    '\n\n' + `<${getRandBase62Str(20)}---ORDERED_LIST_BOUNDARY---${getRandBase62Str(20)}>` + '\n\n'
