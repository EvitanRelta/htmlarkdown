...
describe('Custom Rules & Processes', () => {
    ...
    test.concurrent('rule', async () => {
        ...
        expect(_.isEqual(htmlarkdown.options.preProcesses, HTMLarkdown.defaultPreProcesses)).toBe(
            true
        )
    ...
    test.concurrent('text-process', async () => {
    ...
    test.concurrent('post-process', async () => {
